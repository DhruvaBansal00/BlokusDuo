        ...
        if(piecePicked>-1)
        {
            ...
            if(midSquare[0]>-1 && midSquare[1]>-1)
            {
                if(player1pressed && playerturn)
                {
                    ...
                    for (int x = 0; x < 5; x++) {
                        for (int y = 0; y < 5; y++) {
                            if (player1.playerPieces[piecePicked].pieceIndex[x][y] > 0 && (grid[midSquare[0] - (1 - y)+1][midSquare[1] - (2 - x) + 3].getColor() == 1 || grid[midSquare[0] - (1 - y)+1][midSquare[1] - (2 - x) + 1].getColor() == 1 || grid[midSquare[0] - (1 - y) -1][midSquare[1] - (2 - x) + 3].getColor() == 1 || grid[midSquare[0] - (1 - y)-1][midSquare[1] - (2 - x) + 1].getColor() == 1)) {
                                legal = true;
                            }

                            if (player1.playerPieces[piecePicked].pieceIndex[x][y] > 0 && (midSquare[0] - (1 - y) + 1 >= grid.length || midSquare[0] - (1 - y) - 1 < 0 || midSquare[1] - (2 - x) + 3 >= grid.length || midSquare[1] - (2 - x) + 1 < 0)) {
                                legal = false;
                                break;
                            }
                            if (player1.playerPieces[piecePicked].pieceIndex[x][y] > 0 && (grid[midSquare[0] - (1 - y)][midSquare[1] - (2 - x) + 2].getColor() != 0 || grid[midSquare[0] - (1 - y) - 1][midSquare[1] - (2 - x) + 2].getColor() == 1 || grid[midSquare[0] - (1 - y) + 1][midSquare[1] - (2 - x) + 2].getColor() == 1 || grid[midSquare[0] - (1 - y)][midSquare[1] - (2 - x) + 3].getColor() == 1 || grid[midSquare[0] - (1 - y)][midSquare[1] - (2 - x) + 1].getColor() == 1)) {
                                legal = false;
                                break;
                            }
                        }
                ...
                else if(!player1pressed && !playerturn)
                {
                    ...
                    for (int x = 0; x < 5; x++) {
                        for (int y = 0; y < 5; y++) {
                            if (player2.playerPieces[piecePicked].pieceIndex[x][y] > 0 && (grid[midSquare[0] - (1 - y)+1][midSquare[1] - (2 - x) + 3].getColor() == 1 || grid[midSquare[0] - (1 - y)+1][midSquare[1] - (2 - x) + 1].getColor() == 1 || grid[midSquare[0] - (1 - y) -1][midSquare[1] - (2 - x) + 3].getColor() == 1 || grid[midSquare[0] - (1 - y)-1][midSquare[1] - (2 - x) + 1].getColor() == 1)) {
                                legal = true;
                            }
                            if (player2.playerPieces[piecePicked].pieceIndex[x][y] > 0 && (midSquare[0] - (1 - y)+1>=grid.length || midSquare[0] - (1 - y)-1<0 || midSquare[1] - (2 - x) + 3>=grid.length || midSquare[1] - (2 - x) + 1<0)){
                            legal = false;
                            break;
                            }
                            if (player2.playerPieces[piecePicked].pieceIndex[x][y] > 0 && (grid[midSquare[0] - (1 - y)][midSquare[1] - (2 - x) + 2].getColor()!=0 || grid[midSquare[0] - (1 - y)-1][midSquare[1] - (2 - x) + 2].getColor()==2 || grid[midSquare[0] - (1 - y)+1][midSquare[1] - (2 - x) + 2].getColor()==2 || grid[midSquare[0] - (1 - y)][midSquare[1] - (2 - x) + 3].getColor()==2 || grid[midSquare[0] - (1 - y)][midSquare[1] - (2 - x) + 1].getColor()==2)) {
                            legal = false;
                            }
                        }
